import { canPark, canParkUntil } from './core'
...
describe('canParkUntil', () => {
  ...
  it('is an even day', () => {
    expectCanParkUntil('May 08, 2018 4:00 PM', 'May 09, 2018 07:59 AM', IS_EVEN_SIDE)
    expectCanParkUntil('May 08, 2018 6:00 PM', 'May 10, 2018 07:59 AM', !IS_EVEN_SIDE)
  })

  it('is Saturday and Monday is an odd day', () => {
    expectCanParkUntil('May 19, 2018 6:00 PM', 'May 21, 2018 07:59 AM', IS_EVEN_SIDE)
    expectCanParkUntil('May 19, 2018 6:00 PM', 'May 22, 2018 07:59 AM', !IS_EVEN_SIDE)
  })

  it('is Saturday and Monday is an even day', () => {
    expectCanParkUntil('May 26, 2018 6:00 PM', 'May 29, 2018 07:59 AM', IS_EVEN_SIDE)
    expectCanParkUntil('May 26, 2018 6:00 PM', 'May 28, 2018 07:59 AM', !IS_EVEN_SIDE)
  })

  it('is Sunday and the next day is an even day', () => {
    expectCanParkUntil('May 20, 2018 6:00 PM', 'May 21, 2018 07:59 AM', IS_EVEN_SIDE)
    expectCanParkUntil('May 20, 2018 6:00 PM', 'May 22, 2018 07:59 AM', !IS_EVEN_SIDE)
  })

  it('is an odd day and the next day is also an odd day', () => {
    expectCanParkUntil('May 31, 2018 6:00 PM', 'June 01, 2018 07:59 AM', IS_EVEN_SIDE)
    expectCanParkUntil('May 31, 2018 6:00 PM', 'June 02, 2018 07:59 AM', !IS_EVEN_SIDE)
  })
})